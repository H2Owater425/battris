...
static const ManyLayer DEFAULT_MANY_LAYER = { NULL, 0, NULL, 0, RGB(0, 0, 0), NULL, NULL, _initialize, _renderAll, NULL, _getBitmapHandleFromPath, _getBitmapHandleFromResource };
