	...
	if(isChallenger) {
		...
		*_socket = socket(PF_INET, SOCK_STREAM, IPPROTO_TCP);
		...
		manyLayer->texts = (Text[]){
			{ L"Type challenged's IP", 700, 448, 36, 96, 600, L"소야논8", RGB(255, 255, 255), false },
			{ ip, 1104, 736, 20, 50, 600, L"소야논8", RGB(255, 255, 255), false }
		};
...
inline void startGameMultiplayer(ManyLayer* manyLayer, bool isChallenger) {
	...
	manyLayer->texts = (Text[]){
		{ malloc(sizeof(wchar_t) * 7), 784, 1356, 20, 50, 600, L"소야논8", RGB(255, 255, 255), false },
		{ malloc(sizeof(wchar_t) * 7), 72, 768, 20, 50, 600, L"소야논8", RGB(255, 255, 255), true },
		{ L"Hold", 32, 64, 26, 65, 600, L"소야논8", RGB(255, 255, 255), false },
		{ L"Next", 1040, 64, 26, 65, 600, L"소야논8", RGB(255, 255, 255), false },
		{ L"Combo", -32, 672, 26, 65, 600, L"소야논8", RGB(255, 255, 255), true },
		{ L"Localhost", 248, 1356, 20, 50, 600, L"소야논8", RGB(255, 255, 255), false },
		{ malloc(sizeof(wchar_t) * 7), 2080, 1356, 20, 50, 600, L"소야논8", RGB(255, 255, 255), false },
		{ malloc(sizeof(wchar_t) * 7), 1368, 768, 20, 50, 600, L"소야논8", RGB(255, 255, 255), true },
		{ L"Hold", 1328, 64, 26, 65, 600, L"소야논8", RGB(255, 255, 255), false },
		{ L"Next", 2336, 64, 26, 65, 600, L"소야논8", RGB(255, 255, 255), false },
		{ L"Combo", 1264, 672, 26, 65, 600, L"소야논8", RGB(255, 255, 255), true },
		{ malloc(sizeof(wchar_t) * 16), 936 + 608, 1356, 20, 50, 600, L"소야논8", RGB(255, 255, 255), false},
		{ L"|", 1264, -157, 32, 1297, 100, L"소야논8", RGB(255, 255, 255), false }
	};
	...
	manyLayer->texts = (Text[]){
		{ manyLayer->texts[0].content, 924, 896, 20, 50, 500, L"소야논8", RGB(255, 255, 255), false},
		{ manyLayer->texts[6].content, 1436, 896, 20, 50, 500, L"소야논8", RGB(255, 255, 255), false},
		{ isWin ? L" Win" : L"Lose", 1148, 416, 36, 96, 600, L"소야논8", RGB(255, 255, 255), false},
		{ L"Score", 1216, 742, 15, 40, 500, L"소야논8", RGB(255, 255, 255), false},
		{ L"Localhost", 924, 838, 15, 40, 500, L"소야논8", RGB(255, 255, 255), false},
		{ manyLayer->texts[11].content, 1432, 838, 15, 40, 500, L"소야논8", RGB(255, 255, 255), false},
	};
